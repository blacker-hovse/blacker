        ...
        switch ($_POST['do']) {
            case 'add':
                 ...
                 if (ini_get("magic_quotes_runtime") or ini_get("magic_quotes_gpc")) {
                      $sql = "INSERT INTO ".$_qdbs['tpfx']."quotes (id,quote) VALUES ('NULL', '".mysql_real_escape_string(stripslashes($quote))."')";
                 } else {
                      $sql = "INSERT INTO ".$_qdbs['tpfx']."quotes (id,quote) VALUES ('NULL', '".mysql_real_escape_string($quote)."')";
                 }
                 $r = $db->_sql($sql);
                 print($tpl->fetch($tpl->tdir.'layout_header.tpl'));
